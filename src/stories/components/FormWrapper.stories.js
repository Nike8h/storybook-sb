...
<div class="sm:mx-auto sm:w-full sm:max-w-md">
  <img class="mx-auto h-12 w-auto" src="https://stylebase.ai/wp-content/uploads/2022/04/cropped-Group-18-1.png" alt="Workflow" />
  <h2 class="mt-6 text-center text-3xl font-extrabold text-gray-900">Form Wrapper</h2>
